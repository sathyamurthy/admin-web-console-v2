...
from Core.UserManagement.models import GlobalUserModel as User,AnonymousUser as Anonymous
from Core.Countries.models import WorldCountries

class Sandvik(User):
    class Meta:
        verbose_name = _('Sandvik User')
        verbose_name_plural = _('Sandvik Users')
