...
(j=j+(" "+l+"="+i[l]))}return'<tr role="row" id="'+d+'" tabindex="'+h+'" class="'+e+'"'+(c===""?"":' style="'+c+'"')+j+">"},y=function(d,c,e,f,g){var i=new Date,h=b.p.datatype!=="local"&&b.p.loadonce||b.p.datatype==="xmlstring",j=b.p.xmlReader,l=b.p.datatype==="local"?"local":"xml";if(h){b.p.data=[];b.p._index={};b.p.localReader.id="_id_"}b.p.reccount=0;if(a.isXMLDoc(d)){if(b.p.treeANode===-1&&!b.p.scroll){w.call(b,false,true);e=1}else e=e>1?e:1;var m=a(b),k,n,p=0,y,C=b.p.multiselect===true?1:0,x=
0,N,u=b.p.rownumbers===true?1:0,D,B=[],H,F={},I,z,A=[],T=b.p.altRows===true?b.p.altclass:"",M;if(b.p.subGrid===true){x=1;N=a.jgrid.getMethod("addSubGridCell")}j.repeatitems||(B=t(l));D=b.p.keyIndex===false?a.isFunction(j.id)?j.id.call(b,d):j.id:b.p.keyIndex;if(B.length>0&&!isNaN(D)){b.p.remapColumns&&b.p.remapColumns.length&&(D=a.inArray(D,b.p.remapColumns));D=B[D]}l=(""+D).indexOf("[")===-1?B.length?function(b,d){return a(D,b).text()||d}:function(b,d){return a(j.cell,b).eq(D).text()||d}:function(a,
b){return a.getAttribute(D.replace(/[\[\]]/g,""))||b};b.p.userData={};b.p.page=o(a.jgrid.getXmlData(d,j.page),b.p.page);b.p.lastpage=o(a.jgrid.getXmlData(d,j.total),1);b.p.records=o(a.jgrid.getXmlData(d,j.records));a.isFunction(j.userdata)?b.p.userData=j.userdata.call(b,d)||{}:a.jgrid.getXmlData(d,j.userdata,true).each(function(){b.p.userData[this.getAttribute("name")]=a(this).text()});d=a.jgrid.getXmlData(d,j.root,true);(d=a.jgrid.getXmlData(d,j.row,true))||(d=[]);var E=d.length,G=0,Q=[],L=parseInt(b.p.rowNum,
10),S=b.p.scroll?a.jgrid.randId():1;if(E>0&&b.p.page<=0)b.p.page=1;if(d&&E){g&&(L=L*(g+1));var g=a.isFunction(b.p.afterInsertRow),X=false,K;if(b.p.grouping){X=b.p.groupingView.groupCollapse===true;K=a.jgrid.getMethod("groupingPrepare")}for(;G<E;){I=d[G];z=l(I,S+G);z=b.p.idPrefix+z;k=e===0?0:e+1;M=(k+G)%2===1?T:"";var P=A.length;A.push("");u&&A.push(s(0,G,b.p.page,b.p.rowNum));C&&A.push(r(z,u,G,false));x&&A.push(N.call(m,C+u,G+e));if(j.repeatitems){H||(H=v(C+x+u));var R=a.jgrid.getXmlData(I,j.cell,
true);a.each(H,function(a){var d=R[this];if(!d)return false;y=d.textContent||d.text;F[b.p.colModel[a+C+x+u].name]=y;A.push(q(z,y,a+C+x+u,G+e,I,F))})}else for(k=0;k<B.length;k++){y=a.jgrid.getXmlData(I,B[k]);F[b.p.colModel[k+C+x+u].name]=y;A.push(q(z,y,k+C+x+u,G+e,I,F))}A[P]=J(z,X,M,F,I,false);A.push("</tr>");if(b.p.grouping){Q=K.call(m,A,Q,F,G);A=[]}if(h||b.p.treeGrid===true){F._id_=a.jgrid.stripPref(b.p.idPrefix,z);b.p.data.push(F);b.p._index[F._id_]=b.p.data.length-1}if(b.p.gridview===false){a("tbody:first",
c).append(A.join(""));m.triggerHandler("jqGridAfterInsertRow",[z,F,I]);g&&b.p.afterInsertRow.call(b,z,F,I);A=[]}F={};p++;G++;if(p===L)break}}if(b.p.gridview===true){n=b.p.treeANode>-1?b.p.treeANode:0;if(b.p.grouping){m.jqGrid("groupingRender",Q,b.p.colModel.length);Q=null}else b.p.treeGrid===true&&n>0?a(b.rows[n]).after(A.join("")):a("tbody:first",c).append(A.join(""))}if(b.p.subGrid===true)try{m.jqGrid("addSubGrid",C+u)}catch(ca){}b.p.totaltime=new Date-i;if(p>0&&b.p.records===0)b.p.records=E;A=
null;if(b.p.treeGrid===true)try{m.jqGrid("setTreeNode",n+1,p+n+1)}catch(V){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=p;b.p.treeANode=-1;b.p.userDataOnFooter&&m.jqGrid("footerData","set",b.p.userData,true);if(h){b.p.records=E;b.p.lastpage=Math.ceil(E/L)}f||b.updatepager(false,true);if(h)for(;p<E;){I=d[p];z=l(I,p+S);z=b.p.idPrefix+z;if(j.repeatitems){H||(H=v(C+x+u));var O=a.jgrid.getXmlData(I,j.cell,true);a.each(H,function(a){var d=O[this];if(!d)return false;y=d.textContent||
d.text;F[b.p.colModel[a+C+x+u].name]=y})}else for(k=0;k<B.length;k++){y=a.jgrid.getXmlData(I,B[k]);F[b.p.colModel[k+C+x+u].name]=y}F._id_=a.jgrid.stripPref(b.p.idPrefix,z);b.p.data.push(F);b.p._index[F._id_]=b.p.data.length-1;F={};p++}}},D=function(d,c,e,f,g){var i=new Date;if(d){if(b.p.treeANode===-1&&!b.p.scroll){w.call(b,false,true);e=1}else e=e>1?e:1;var h,j=b.p.datatype!=="local"&&b.p.loadonce||b.p.datatype==="jsonstring";if(j){b.p.data=[];b.p._index={};b.p.localReader.id="_id_"}b.p.reccount=
0;if(b.p.datatype==="local"){c=b.p.localReader;h="local"}else{c=b.p.jsonReader;h="json"}var l=a(b),k=0,m,n,p,y=[],C=b.p.multiselect?1:0,x=b.p.subGrid===true?1:0,u,N=b.p.rownumbers===true?1:0,D=v(C+x+N);h=t(h);var F,z,B,I={},H,A,G=[],E=b.p.altRows===true?b.p.altclass:"",T;b.p.page=o(a.jgrid.getAccessor(d,c.page),b.p.page);b.p.lastpage=o(a.jgrid.getAccessor(d,c.total),1);b.p.records=o(a.jgrid.getAccessor(d,c.records));b.p.userData=a.jgrid.getAccessor(d,c.userdata)||{};x&&(u=a.jgrid.getMethod("addSubGridCell"));
B=b.p.keyIndex===false?a.isFunction(c.id)?c.id.call(b,d):c.id:b.p.keyIndex;if(!c.repeatitems){y=h;if(y.length>0&&!isNaN(B)){b.p.remapColumns&&b.p.remapColumns.length&&(B=a.inArray(B,b.p.remapColumns));B=y[B]}}z=a.jgrid.getAccessor(d,c.root);z==null&&a.isArray(d)&&(z=d);z||(z=[]);d=z.length;n=0;if(d>0&&b.p.page<=0)b.p.page=1;var M=parseInt(b.p.rowNum,10),Q=b.p.scroll?a.jgrid.randId():1,L=false,S;g&&(M=M*(g+1));b.p.datatype==="local"&&!b.p.deselectAfterSort&&(L=true);var X=a.isFunction(b.p.afterInsertRow),
K=[],P=false,R;if(b.p.grouping){P=b.p.groupingView.groupCollapse===true;R=a.jgrid.getMethod("groupingPrepare")}for(;n<d;){g=z[n];A=a.jgrid.getAccessor(g,B);if(A===void 0){typeof B==="number"&&b.p.colModel[B+C+x+N]!=null&&(A=a.jgrid.getAccessor(g,b.p.colModel[B+C+x+N].name));if(A===void 0){A=Q+n;if(y.length===0&&c.cell){m=a.jgrid.getAccessor(g,c.cell)||g;A=m!=null&&m[B]!==void 0?m[B]:A}}}A=b.p.idPrefix+A;m=e===1?0:e;T=(m+n)%2===1?E:"";L&&(S=b.p.multiselect?a.inArray(A,b.p.selarrrow)!==-1:A===b.p.selrow);
var ca=G.length;G.push("");N&&G.push(s(0,n,b.p.page,b.p.rowNum));C&&G.push(r(A,N,n,S));x&&G.push(u.call(l,C+N,n+e));F=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(F=D)}for(p=0;p<F.length;p++){m=a.jgrid.getAccessor(g,F[p]);I[b.p.colModel[p+C+x+N].name]=m;G.push(q(A,m,p+C+x+N,n+e,g,I))}G[ca]=J(A,P,T,I,g,S);G.push("</tr>");if(b.p.grouping){K=R.call(l,G,K,I,n);G=[]}if(j||b.p.treeGrid===true){I._id_=a.jgrid.stripPref(b.p.idPrefix,A);b.p.data.push(I);b.p._index[I._id_]=
b.p.data.length-1}if(b.p.gridview===false){a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(G.join(""));l.triggerHandler("jqGridAfterInsertRow",[A,I,g]);X&&b.p.afterInsertRow.call(b,A,I,g);G=[]}I={};k++;n++;if(k===M)break}if(b.p.gridview===true){H=b.p.treeANode>-1?b.p.treeANode:0;b.p.grouping?l.jqGrid("groupingRender",K,b.p.colModel.length):b.p.treeGrid===true&&H>0?a(b.rows[H]).after(G.join("")):a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(G.join(""))}if(b.p.subGrid===true)try{l.jqGrid("addSubGrid",
C+N)}catch(O){}b.p.totaltime=new Date-i;if(k>0&&b.p.records===0)b.p.records=d;if(b.p.treeGrid===true)try{l.jqGrid("setTreeNode",H+1,k+H+1)}catch(V){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=k;b.p.treeANode=-1;b.p.userDataOnFooter&&l.jqGrid("footerData","set",b.p.userData,true);if(j){b.p.records=d;b.p.lastpage=Math.ceil(d/M)}f||b.updatepager(false,true);if(j)for(;k<d&&z[k];){g=z[k];A=a.jgrid.getAccessor(g,B);if(A===void 0){typeof B==="number"&&b.p.colModel[B+C+x+N]!=null&&
(A=a.jgrid.getAccessor(g,b.p.colModel[B+C+x+N].name));if(A===void 0){A=Q+k;if(y.length===0&&c.cell){e=a.jgrid.getAccessor(g,c.cell)||g;A=e!=null&&e[B]!==void 0?e[B]:A}}}if(g){A=b.p.idPrefix+A;F=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(F=D)}for(p=0;p<F.length;p++)I[b.p.colModel[p+C+x+N].name]=a.jgrid.getAccessor(g,F[p]);I._id_=a.jgrid.stripPref(b.p.idPrefix,A);b.p.data.push(I);b.p._index[I._id_]=b.p.data.length-1;I={}}k++}}},M=function(){function d(a){var b=0,
...
g[b.p.postData.searchField])}catch(t){}}if(b.p.grouping)for(o=0;o<n;o++)p.orderBy(h[o],m.groupOrder[o],i[o].stype,i[o].srcfmt);b.p.multiSort?a.each(c,function(a){p.orderBy(this,e[a],g[this].stype,g[this].srcfmt)}):c&&b.p.sortorder&&f&&(b.p.sortorder.toUpperCase()==="DESC"?p.orderBy(b.p.sortname,"d",g[c].stype,g[c].srcfmt):p.orderBy(b.p.sortname,"a",g[c].stype,g[c].srcfmt));var r=p.select(),s=parseInt(b.p.rowNum,10),w=r.length,y=parseInt(b.p.page,10),C=Math.ceil(w/s),x={},r=r.slice((y-1)*s,y*s),g=
p=null;x[b.p.localReader.total]=C;x[b.p.localReader.page]=y;x[b.p.localReader.records]=w;x[b.p.localReader.root]=r;x[b.p.localReader.userdata]=b.p.userData;r=null;return x}}},u=function(){b.grid.hDiv.loading=true;if(!b.p.hiddengrid)switch(b.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(b.p.id)).show();break;case "block":a("#lui_"+a.jgrid.jqID(b.p.id)).show();a("#load_"+a.jgrid.jqID(b.p.id)).show()}},L=function(){b.grid.hDiv.loading=false;switch(b.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(b.p.id)).hide();
break;case "block":a("#lui_"+a.jgrid.jqID(b.p.id)).hide();a("#load_"+a.jgrid.jqID(b.p.id)).hide()}},z=function(d){if(!b.grid.hDiv.loading){var c=b.p.scroll&&d===false,e={},f,g=b.p.prmNames;if(b.p.page<=0)b.p.page=Math.min(1,b.p.lastpage);if(g.search!==null)e[g.search]=b.p.search;g.nd!==null&&(e[g.nd]=(new Date).getTime());if(g.rows!==null)e[g.rows]=b.p.rowNum;if(g.page!==null)e[g.page]=b.p.page;if(g.sort!==null)e[g.sort]=b.p.sortname;if(g.order!==null)e[g.order]=b.p.sortorder;if(b.p.rowTotal!==null&&
g.totalrows!==null)e[g.totalrows]=b.p.rowTotal;var i=a.isFunction(b.p.loadComplete),h=i?b.p.loadComplete:null,j=0,d=d||1;if(d>1)if(g.npage!==null){e[g.npage]=d;j=d-1;d=1}else h=function(a){b.p.page++;b.grid.hDiv.loading=false;i&&b.p.loadComplete.call(b,a);z(d-1)};else g.npage!==null&&delete b.p.postData[g.npage];if(b.p.grouping){a(b).jqGrid("groupingSetup");var l=b.p.groupingView,k,m="";for(k=0;k<l.groupField.length;k++){var n=l.groupField[k];a.each(b.p.colModel,function(a,b){if(b.name===n&&b.index)n=
b.index});m=m+(n+" "+l.groupOrder[k]+", ")}e[g.sort]=m+e[g.sort]}a.extend(b.p.postData,e);var o=!b.p.scroll?1:b.rows.length-1,e=a(b).triggerHandler("jqGridBeforeRequest");if(!(e===false||e==="stop"))if(a.isFunction(b.p.datatype))b.p.datatype.call(b,b.p.postData,"load_"+b.p.id);else{if(a.isFunction(b.p.beforeRequest)){e=b.p.beforeRequest.call(b);e===void 0&&(e=true);if(e===false)return}f=b.p.datatype.toLowerCase();switch(f){case "json":case "jsonp":case "xml":case "script":a.ajax(a.extend({url:b.p.url,
type:b.p.mtype,dataType:f,data:a.isFunction(b.p.serializeGridData)?b.p.serializeGridData.call(b,b.p.postData):b.p.postData,success:function(e,g,i){if(a.isFunction(b.p.beforeProcessing)&&b.p.beforeProcessing.call(b,e,g,i)===false)L();else{f==="xml"?y(e,b.grid.bDiv,o,d>1,j):D(e,b.grid.bDiv,o,d>1,j);a(b).triggerHandler("jqGridLoadComplete",[e]);h&&h.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);c&&b.grid.populateVisible();if(b.p.loadonce||b.p.treeGrid)b.p.datatype="local";d===1&&L()}},
error:function(c,e,f){a.isFunction(b.p.loadError)&&b.p.loadError.call(b,c,e,f);d===1&&L()},beforeSend:function(d,c){var e=true;a.isFunction(b.p.loadBeforeSend)&&(e=b.p.loadBeforeSend.call(b,d,c));e===void 0&&(e=true);if(e===false)return false;u()}},a.jgrid.ajaxOptions,b.p.ajaxGridOptions));break;case "xmlstring":u();e=typeof b.p.datastr!=="string"?b.p.datastr:a.parseXML(b.p.datastr);y(e,b.grid.bDiv);a(b).triggerHandler("jqGridLoadComplete",[e]);i&&b.p.loadComplete.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",
[e]);b.p.datatype="local";b.p.datastr=null;L();break;case "jsonstring":u();e=typeof b.p.datastr==="string"?a.jgrid.parse(b.p.datastr):b.p.datastr;D(e,b.grid.bDiv);a(b).triggerHandler("jqGridLoadComplete",[e]);i&&b.p.loadComplete.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);b.p.datatype="local";b.p.datastr=null;L();break;case "local":case "clientside":u();b.p.datatype="local";e=M();D(e,b.grid.bDiv,o,d>1,j);a(b).triggerHandler("jqGridLoadComplete",[e]);h&&h.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",
[e]);c&&b.grid.populateVisible();L()}}}},P=function(d){a("#cb_"+a.jgrid.jqID(b.p.id),b.grid.hDiv)[b.p.useProp?"prop":"attr"]("checked",d);if(b.p.frozenColumns&&b.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(b.p.id),b.grid.fhDiv)[b.p.useProp?"prop":"attr"]("checked",d)},V=function(d,c){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",g="",h,j,l,k,m=function(d){var c;a.isFunction(b.p.onPaging)&&(c=b.p.onPaging.call(b,d));b.p.selrow=null;
if(b.p.multiselect){b.p.selarrrow=[];P(false)}b.p.savedRow=[];return c==="stop"?false:true},d=d.substr(1),c=c+("_"+d);h="pg_"+d;j=d+"_left";l=d+"_center";k=d+"_right";a("#"+a.jgrid.jqID(d)).append("<div id='"+h+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+j+"' align='left'></td><td id='"+l+"' align='center' style='white-space:pre;'></td><td id='"+k+"' align='right'></td></tr></tbody></table></div>").attr("dir",
...
"last"+c&&h){b.p.page=d;e=true}e&&z();return false})}b.p.pginput===true&&a("input.ui-pg-input","#"+h).keypress(function(d){if((d.charCode||d.keyCode||0)===13){if(!m("user"))return false;a(this).val(o(a(this).val(),1));b.p.page=a(this).val()>0?a(this).val():b.p.page;z();return false}return this})},Y=function(d,c){var e,f="",g=b.p.colModel,i=false,h;h=b.p.frozenColumns?c:b.grid.headers[d].el;var j="";a("span.ui-grid-ico-sort",h).addClass("ui-state-disabled");a(h).attr("aria-selected","false");if(g[d].lso)if(g[d].lso===
...
a("span.s-ico",e).hide();a("span.s-ico",g).show()}d=d.substring(5+b.p.id.length+1);b.p.sortname=b.p.colModel[c].index||d;i=b.p.sortorder}if(a(b).triggerHandler("jqGridSortCol",[d,c,i])==="stop")b.p.lastsort=c;else if(a.isFunction(b.p.onSortCol)&&b.p.onSortCol.call(b,d,c,i)==="stop")b.p.lastsort=c;else{if(b.p.datatype==="local")b.p.deselectAfterSort&&a(b).jqGrid("resetSelection");else{b.p.selrow=null;b.p.multiselect&&P(false);b.p.selarrrow=[];b.p.savedRow=[]}if(b.p.scroll){g=b.grid.bDiv.scrollLeft;
w.call(b,true,false);b.grid.hDiv.scrollLeft=g}b.p.subGrid&&b.p.datatype==="local"&&a("td.sgexpanded","#"+a.jgrid.jqID(b.p.id)).each(function(){a(this).trigger("click")});z();b.p.lastsort=c;if(b.p.sortname!==d&&c)b.p.lastsort=c}}}},ba=function(d){d=a(b.grid.headers[d].el);d=[d.position().left+d.outerWidth()];b.p.direction==="rtl"&&(d[0]=b.p.width-d[0]);d[0]=d[0]-b.grid.bDiv.scrollLeft;d.push(a(b.grid.hDiv).position().top);d.push(a(b.grid.bDiv).offset().top-a(b.grid.hDiv).offset().top+a(b.grid.bDiv).height());
...
!0===b.p.grouping&&(b.p.scroll=!1,b.p.rownumbers=!1,b.p.treeGrid=!1,b.p.gridview=!0);if(!0===this.p.treeGrid){try{a(this).jqGrid("setTreeGrid")}catch(da){}"local"!==b.p.datatype&&(b.p.localReader={id:"_id_"})}if(this.p.subGrid)try{a(b).jqGrid("setSubGrid")}catch(ea){}this.p.multiselect&&(this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/>"),this.p.colModel.unshift({name:"cb",width:a.jgrid.cell_width?b.p.multiselectWidth+b.p.cellLayout:b.p.multiselectWidth,
...
a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},b.p.jsonReader);b.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},b.p.localReader);b.p.scroll&&(b.p.pgbuttons=!1,b.p.pginput=!1,b.p.rowList=[]);b.p.data.length&&x();var C="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",
N,B,F,S,G,H,E,T,ca=T="",Q=[],ha=[];B=[];if(!0===b.p.shrinkToFit&&!0===b.p.forceFit)for(g=b.p.colModel.length-1;0<=g;g--)if(!b.p.colModel[g].hidden){b.p.colModel[g].resizable=!1;break}"horizontal"===b.p.viewsortcols[1]&&(T=" ui-i-asc",ca=" ui-i-desc");N=k?"class='ui-th-div-ie'":"";T="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+T+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+i+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+
ca+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+i+"'></span></span>");if(b.p.multiSort){Q=b.p.sortname.split(",");for(g=0;g<Q.length;g++)B=a.trim(Q[g]).split(" "),Q[g]=a.trim(B[0]),ha[g]=B[1]?a.trim(B[1]):b.p.sortorder||"asc"}for(g=0;g<this.p.colNames.length;g++)B=b.p.headertitles?' title="'+a.jgrid.stripHtml(b.p.colNames[g])+'"':"",C+="<th id='"+b.p.id+"_"+b.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+i+"'"+B+">",B=b.p.colModel[g].index||b.p.colModel[g].name,
C+="<div id='jqgh_"+b.p.id+"_"+b.p.colModel[g].name+"' "+N+">"+b.p.colNames[g],b.p.colModel[g].width=b.p.colModel[g].width?parseInt(b.p.colModel[g].width,10):150,"boolean"!==typeof b.p.colModel[g].title&&(b.p.colModel[g].title=!0),b.p.colModel[g].lso="",B===b.p.sortname&&(b.p.lastsort=g),b.p.multiSort&&(B=a.inArray(B,Q),-1!==B&&(b.p.colModel[g].lso=ha[B])),C+=T+"</div></th>";T=null;a(this).append(C+"</tr></thead>");a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});
...
b.p.width){b.p.colModel[g].width=b.p.colModel[g].width-(b.p.tblwidth-parseInt(b.p.width,10));b.p.tblwidth=b.p.width}}})();a(m).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+b.p.id+"'>&#160;</div>");a(j).css("width",e.width+"px");var C=a("thead:first",b).get(0),R="";b.p.footerrow&&(R+="<table role='grid' style='width:"+b.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+
i+"'>");var j=a("tr:first",C),aa="<tr class='jqgfirstrow' role='row' style='height:auto'>";b.p.disableClick=!1;a("th",j).each(function(d){F=b.p.colModel[d].width;if(b.p.colModel[d].resizable===void 0)b.p.colModel[d].resizable=true;if(b.p.colModel[d].resizable){S=document.createElement("span");a(S).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+i).css("cursor","col-resize");a(this).addClass(b.p.resizeclass)}else S="";a(this).css("width",F+"px").prepend(S);var c="";if(b.p.colModel[d].hidden){a(this).css("display",
"none");c="display:none;"}aa=aa+("<td role='gridcell' style='height:0px;width:"+F+"px;"+c+"'></td>");e.headers[d]={width:F,el:this};G=b.p.colModel[d].sortable;if(typeof G!=="boolean")G=b.p.colModel[d].sortable=true;c=b.p.colModel[d].name;c==="cb"||c==="subgrid"||c==="rn"||b.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");if(G)if(b.p.multiSort)if(b.p.viewsortcols[0]){a("div span.s-ico",this).show();b.p.colModel[d].lso&&a("div span.ui-icon-"+b.p.colModel[d].lso,this).removeClass("ui-state-disabled")}else{if(b.p.colModel[d].lso){a("div span.s-ico",
this).show();a("div span.ui-icon-"+b.p.colModel[d].lso,this).removeClass("ui-state-disabled")}}else if(b.p.viewsortcols[0]){a("div span.s-ico",this).show();d===b.p.lastsort&&a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")}else if(d===b.p.lastsort){a("div span.s-ico",this).show();a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")}b.p.footerrow&&(R=R+("<td role='gridcell' "+n(d,0,"",null,"",false)+">&#160;</td>"))}).mousedown(function(d){if(a(d.target).closest("th>span.ui-jqgrid-resize").length===
1){var c=Z(this);if(b.p.forceFit===true){var f=b.p,g=c,i;for(i=c+1;i<b.p.colModel.length;i++)if(b.p.colModel[i].hidden!==true){g=i;break}f.nv=g-c}e.dragStart(c,d,ba(c));return false}}).click(function(d){if(b.p.disableClick)return b.p.disableClick=false;var c="th>div.ui-jqgrid-sortable",e,f;b.p.viewsortcols[2]||(c="th>div>span>span.ui-grid-ico-sort");d=a(d.target).closest(c);if(d.length===1){var g;if(b.p.frozenColumns){var i=a(this)[0].id.substring(b.p.id.length);a(b.p.colModel).each(function(a){if(this.name===
i){g=a;return false}})}else g=Z(this);if(!b.p.viewsortcols[2]){e=true;f=d.attr("sort")}g!=null&&W(a("div",this)[0].id,g,e,f,this);return false}});if(b.p.sortable&&a.fn.sortable)try{a(b).jqGrid("sortableColumns",j)}catch(ja){}b.p.footerrow&&(R+="</tr></tbody></table>");aa+="</tr>";this.appendChild(document.createElement("tbody"));a(this).addClass("ui-jqgrid-btable").append(aa);var aa=null,j=a("<table class='ui-jqgrid-htable' style='width:"+b.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+this.id+
"' cellspacing='0' cellpadding='0' border='0'></table>").append(C),O=b.p.caption&&!0===b.p.hiddengrid?!0:!1;g=a("<div class='ui-jqgrid-hbox"+("rtl"===i?"-rtl":"")+"'></div>");C=null;e.hDiv=document.createElement("div");a(e.hDiv).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(g);a(g).append(j);j=null;O&&a(e.hDiv).hide();b.p.pager&&("string"===typeof b.p.pager?"#"!==b.p.pager.substr(0,1)&&(b.p.pager="#"+b.p.pager):b.p.pager="#"+a(b.p.pager).attr("id"),a(b.p.pager).css({width:e.width+
"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(m),O&&a(b.p.pager).hide(),V(b.p.pager,""));!1===b.p.cellEdit&&!0===b.p.hoverrows&&a(b).bind("mouseover",function(b){E=a(b.target).closest("tr.jqgrow");a(E).attr("class")!=="ui-subgrid"&&a(E).addClass("ui-state-hover")}).bind("mouseout",function(b){E=a(b.target).closest("tr.jqgrow");a(E).removeClass("ui-state-hover")});var K,U,fa;a(b).before(e.hDiv).click(function(d){H=d.target;E=a(H,b.rows).closest("tr.jqgrow");if(a(E).length===
0||E[0].className.indexOf("ui-state-disabled")>-1||(a(H,b).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==b.id)return this;var c=a(H).hasClass("cbox"),e=a(b).triggerHandler("jqGridBeforeSelectRow",[E[0].id,d]);(e=e===false||e==="stop"?false:true)&&a.isFunction(b.p.beforeSelectRow)&&(e=b.p.beforeSelectRow.call(b,E[0].id,d));if(!(H.tagName==="A"||(H.tagName==="INPUT"||H.tagName==="TEXTAREA"||H.tagName==="OPTION"||H.tagName==="SELECT")&&!c)&&e===true){K=E[0].id;U=a.jgrid.getCellIndex(H);
fa=a(H).closest("td,th").html();a(b).triggerHandler("jqGridCellSelect",[K,U,fa,d]);a.isFunction(b.p.onCellSelect)&&b.p.onCellSelect.call(b,K,U,fa,d);if(b.p.cellEdit===true)if(b.p.multiselect&&c)a(b).jqGrid("setSelection",K,true,d);else{K=E[0].rowIndex;try{a(b).jqGrid("editCell",K,U,true)}catch(f){}}else if(b.p.multikey)if(d[b.p.multikey])a(b).jqGrid("setSelection",K,true,d);else{if(b.p.multiselect&&c){c=a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+K).is(":checked");a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+K)[b.p.useProp?
...
false)}});b.p.selarrrow=[]}a(b).jqGrid("setSelection",K,true,d)}}}).bind("reloadGrid",function(d,c){if(b.p.treeGrid===true)b.p.datatype=b.p.treedatatype;c&&c.current&&b.grid.selectionPreserver(b);if(b.p.datatype==="local"){a(b).jqGrid("resetSelection");b.p.data.length&&x()}else if(!b.p.treeGrid){b.p.selrow=null;if(b.p.multiselect){b.p.selarrrow=[];P(false)}b.p.savedRow=[]}b.p.scroll&&w.call(b,true,false);if(c&&c.page){var e=c.page;if(e>b.p.lastpage)e=b.p.lastpage;e<1&&(e=1);b.p.page=e;b.grid.bDiv.scrollTop=
b.grid.prevRowHeight?(e-1)*b.grid.prevRowHeight*b.p.rowNum:0}if(b.grid.prevRowHeight&&b.p.scroll){delete b.p.lastpage;b.grid.populateVisible()}else b.grid.populate();b.p._inlinenav===true&&a(b).jqGrid("showAddEditButtons");return false}).dblclick(function(d){H=d.target;E=a(H,b.rows).closest("tr.jqgrow");if(a(E).length!==0){K=E[0].rowIndex;U=a.jgrid.getCellIndex(H);a(b).triggerHandler("jqGridDblClickRow",[a(E).attr("id"),K,U,d]);a.isFunction(b.p.ondblClickRow)&&b.p.ondblClickRow.call(b,a(E).attr("id"),
K,U,d)}}).bind("contextmenu",function(d){H=d.target;E=a(H,b.rows).closest("tr.jqgrow");if(a(E).length!==0){b.p.multiselect||a(b).jqGrid("setSelection",E[0].id,true,d);K=E[0].rowIndex;U=a.jgrid.getCellIndex(H);a(b).triggerHandler("jqGridRightClickRow",[a(E).attr("id"),K,U,d]);a.isFunction(b.p.onRightClickRow)&&b.p.onRightClickRow.call(b,a(E).attr("id"),K,U,d)}});e.bDiv=document.createElement("div");k&&"auto"===(""+b.p.height).toLowerCase()&&(b.p.height="100%");a(e.bDiv).append(a('<div style="position:relative;'+
(k&&8>a.jgrid.msiever()?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:b.p.height+(isNaN(b.p.height)?"":"px"),width:e.width+"px"}).scroll(e.scrollGrid);a("table:first",e.bDiv).css({width:b.p.tblwidth+"px"});a.support.tbody||2===a("tbody",this).length&&a("tbody:gt(0)",this).remove();b.p.multikey&&(a.jgrid.msie?a(e.bDiv).bind("selectstart",function(){return false}):a(e.bDiv).bind("mousedown",function(){return false}));O&&a(e.bDiv).hide();e.cDiv=
...
f.name)+"' id='gs_"+f.name+"'/>");a(n).append(l);try{if(a.isFunction(i.custom_element)){var t=i.custom_element.call(e,void 0!==i.defaultValue?i.defaultValue:"",i);if(t)t=a(t).addClass("customelement"),a(n).find(">span").append(t);else throw"e2";}else throw"e1";}catch(v){"e1"===v&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===v?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof v?v:v.message,a.jgrid.edit.bClose)}}}a(o).append(n);a(b).append(o);c.searchOperators||a("td:eq(0)",l).hide()});a("table thead",e.grid.hDiv).append(b);c.searchOperators&&(a(".soptclass").click(function(b){var d=a(this).offset();f(this,d.left,d.top);b.stopPropagation()}),a("body").on("click",function(b){"soptclass"!==b.target.className&&a("#sopt_menu").hide()}));this.ftoolbar=!0;this.triggerToolbar=d;this.clearToolbar=
...
b.groups)for(e=0;e<b.groups.length;e++)i=a("<tr></tr>"),g.append(i),h=a("<td class='first'></td>"),i.append(h),h=a("<td colspan='4'></td>"),h.append(this.createTableForGroup(b.groups[e],b)),i.append(h);void 0===b.groupOp&&(b.groupOp=c.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,d){var c=this,g=j(),h=a("<tr></tr>"),k,r,s,t,v="",w;h.append("<td class='first'></td>");var x=a("<td class='columns'></td>");
h.append(x);var J=a("<select></select>"),y,D=[];x.append(J);J.bind("change",function(){b.field=a(J).val();s=a(this).parents("tr:first");for(k=0;k<c.p.columns.length;k++)if(c.p.columns[k].name===b.field){t=c.p.columns[k];break}if(t){t.searchoptions.id=a.jgrid.randId();e&&"text"===t.inputtype&&!t.searchoptions.size&&(t.searchoptions.size=10);var d=a.jgrid.createEl.call(g,t.inputtype,t.searchoptions,"",!0,c.p.ajaxSelectOptions,!0);a(d).addClass("input-elm");r=t.searchoptions.sopt?t.searchoptions.sopt:
c.p.sopt?c.p.sopt:-1!==a.inArray(t.searchtype,c.p.strarr)?c.p.stropts:c.p.numopts;var f="",h=0;D=[];a.each(c.p.ops,function(){D.push(this.oper)});for(k=0;k<r.length;k++)y=a.inArray(r[k],D),-1!==y&&(0===h&&(b.op=c.p.ops[y].oper),f+="<option value='"+c.p.ops[y].oper+"'>"+c.p.ops[y].text+"</option>",h++);a(".selectopts",s).empty().append(f);a(".selectopts",s)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",s)[0].offsetWidth,10)+1,a(".selectopts",s).width(f),a(".selectopts",
...
for(k=x=0;k<c.p.columns.length;k++){w=void 0===c.p.columns[k].search?!0:c.p.columns[k].search;var M=!0===c.p.columns[k].hidden;if(!0===c.p.columns[k].searchoptions.searchhidden&&w||w&&!M)w="",b.field===c.p.columns[k].name&&(w=" selected='selected'",x=k),v+="<option value='"+c.p.columns[k].name+"'"+w+">"+c.p.columns[k].label+"</option>"}J.append(v);v=a("<td class='operators'></td>");h.append(v);t=f.columns[x];t.searchoptions.id=a.jgrid.randId();e&&"text"===t.inputtype&&!t.searchoptions.size&&(t.searchoptions.size=
10);x=a.jgrid.createEl.call(g,t.inputtype,t.searchoptions,b.data,!0,c.p.ajaxSelectOptions,!0);if("nu"===b.op||"nn"===b.op)a(x).attr("readonly","true"),a(x).attr("disabled","true");var u=a("<select class='selectopts'></select>");v.append(u);u.bind("change",function(){b.op=a(u).val();s=a(this).parents("tr:first");var d=a(".input-elm",s)[0];if(b.op==="nu"||b.op==="nn"){b.data="";d.value="";d.setAttribute("readonly","true");d.setAttribute("disabled","true")}else{d.removeAttribute("readonly");d.removeAttribute("disabled")}c.onchange()});
r=t.searchoptions.sopt?t.searchoptions.sopt:c.p.sopt?c.p.sopt:-1!==a.inArray(t.searchtype,c.p.strarr)?c.p.stropts:c.p.numopts;v="";a.each(c.p.ops,function(){D.push(this.oper)});for(k=0;k<r.length;k++)y=a.inArray(r[k],D),-1!==y&&(w=b.op===c.p.ops[y].oper?" selected='selected'":"",v+="<option value='"+c.p.ops[y].oper+"'"+w+">"+c.p.ops[y].text+"</option>");u.append(v);v=a("<td class='data'></td>");h.append(v);v.append(x);a.jgrid.bindEv.call(g,x,t.searchoptions);a(x).addClass("input-elm").bind("change",
function(){b.data=t.inputtype==="custom"?t.searchoptions.custom_value.call(g,a(this).children(".customelement:first"),"get"):a(this).val();c.onchange()});v=a("<td></td>");h.append(v);!0===this.p.ruleButtons&&(x=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),v.append(x),x.bind("click",function(){for(k=0;k<d.rules.length;k++)if(d.rules[k]===b){d.rules.splice(k,1);break}c.reDraw();c.onchange();return false}));return h};this.getStringForGroup=function(a){var b="(",
...
b){if(!b.label)b.label=f.p.colNames[a];if(!s){var d=b.search===void 0?true:b.search,c=b.hidden===true;if(b.searchoptions&&b.searchoptions.searchhidden===true&&d||d&&!c){s=true;r=b.index||b.name;t=a}}});if(!i&&r||!1===c.multipleSearch){var v="eq";0<=t&&o[t].searchoptions&&o[t].searchoptions.sopt?v=o[t].searchoptions.sopt[0]:c.sopt&&c.sopt.length&&(v=c.sopt[0]);i={groupOp:"AND",rules:[{field:r,op:v,data:""}]}}s=!1;c.tmplNames&&c.tmplNames.length&&(s=!0,q=c.tmplLabel,q+="<select class='ui-template'>",
...
a("td[role='gridcell']:eq("+s+")",d.rows[p]),{rowId:b,colModel:this},s)}catch(r){k=this.edittype&&"textarea"===this.edittype?a("td[role='gridcell']:eq("+s+")",d.rows[p]).text():a("td[role='gridcell']:eq("+s+")",d.rows[p]).html()}if(!k||"&nbsp;"===k||"&#160;"===k||1===k.length&&160===k.charCodeAt(0))k=""}var y=a.extend({},this.editoptions||{},{id:g,name:g}),v=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),w=parseInt(v.rowpos,10)||j+1,x=parseInt(2*(parseInt(v.colpos,
10)||1),10);"_empty"===b&&y.defaultValue&&(k=a.isFunction(y.defaultValue)?y.defaultValue.call(l):y.defaultValue);this.edittype||(this.edittype="text");l.p.autoencode&&(k=a.jgrid.htmlDecode(k));o=a.jgrid.createEl.call(l,this.edittype,y,k,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||{}));if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData[g]=k;a(o).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(o).addClass("ui-widget-content ui-corner-all");
h=a(e).find("tr[rowpos="+w+"]");if(v.rowabove){var u=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+v.rowcontent+"</td></tr>");a(e).append(u);u[0].rp=w}0===h.length&&(h=a("<tr "+m+" rowpos='"+w+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(h).append(t),a(e).append(h),h[0].rp=w);a("td:eq("+(x-2)+")",h[0]).html(void 0===v.label?d.p.colNames[s]:v.label);a("td:eq("+(x-1)+")",h[0]).append(v.elmprefix).append(o).append(v.elmsuffix);a.isFunction(y.custom_value)&&"_empty"!==b&&y.custom_value.call(l,
a("#"+g,"#"+q),"set",k);a.jgrid.bindEv.call(l,o,y);n[j]=s;j++}});if(0<j&&(s=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+b+"'/></td></tr>"),s[0].rp=j+999,a(e).append(s),c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate))c[l.p.id]._savedData[d.p.id+"_id"]=b;return n}function h(b,d,e){var f,g=0,i,h,j,k,m;if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData=
...
a("#"+f,"#"+e),"set",i);else throw"e1";}catch(m){"e1"===m?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,m.message,a.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",s).val(b))}}function g(){a.each(l.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&u.hasOwnProperty(b.name)&&""===u[b.name]&&(u[b.name]="null")})}function i(){var b,e=[!0,"",""],f={},i=l.p.prmNames,j,k,m,o,n,
r=a(l).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+q),z]);r&&"object"===typeof r&&(u=r);a.isFunction(c[l.p.id].beforeCheckValues)&&(r=c[l.p.id].beforeCheckValues.call(l,u,a("#"+q),z))&&"object"===typeof r&&(u=r);for(m in u)if(u.hasOwnProperty(m)&&(e=a.jgrid.checkValues.call(l,u[m],m),!1===e[0]))break;g();e[0]&&(f=a(l).triggerHandler("jqGridAddEditClickSubmit",[c[l.p.id],u,z]),void 0===f&&a.isFunction(c[l.p.id].onclickSubmit)&&(f=c[l.p.id].onclickSubmit.call(l,c[l.p.id],u,z)||{}),e=a(l).triggerHandler("jqGridAddEditBeforeSubmit",
...
a(l).jqGrid("getGridParam","selrow"),u["adjacency"===l.p.treeGridModel?l.p.treeReader.parent_id_field:"parent_id"]=o),l.p.treeReader)l.p.treeReader.hasOwnProperty(n)&&(f=l.p.treeReader[n],u.hasOwnProperty(f)&&!(u[k]===i.addoper&&"parent_id_field"===n)&&delete u[f]);u[j]=a.jgrid.stripPref(l.p.idPrefix,u[j]);n=a.extend({url:c[l.p.id].url||a(l).jqGrid("getGridParam","editurl"),type:c[l.p.id].mtype,data:a.isFunction(c[l.p.id].serializeEditData)?c[l.p.id].serializeEditData.call(l,u):u,complete:function(f,
g){var m;u[j]=l.p.idPrefix+u[j];if(f.status>=300&&f.status!==304){e[0]=false;e[1]=a(l).triggerHandler("jqGridAddEditErrorTextFormat",[f,z]);e[1]=a.isFunction(c[l.p.id].errorTextFormat)?c[l.p.id].errorTextFormat.call(l,f,z):g+" Status: '"+f.statusText+"'. Error code: "+f.status}else{e=a(l).triggerHandler("jqGridAddEditAfterSubmit",[f,u,z]);e===void 0&&(e=[true,"",""]);e[0]&&a.isFunction(c[l.p.id].afterSubmit)&&(e=c[l.p.id].afterSubmit.call(l,f,u,z))}if(e[0]===false){a("#FormError>td",s).html(e[1]);
a("#FormError",s).show()}else{l.p.autoencode&&a.each(u,function(b,d){u[b]=a.jgrid.htmlDecode(d)});if(u[k]===i.addoper){e[2]||(e[2]=a.jgrid.randId());u[j]=e[2];c[l.p.id].reloadAfterSubmit?a(l).trigger("reloadGrid"):l.p.treeGrid===true?a(l).jqGrid("addChildNode",e[2],o,u):a(l).jqGrid("addRowData",e[2],u,d.addedrow);if(c[l.p.id].closeAfterAdd){l.p.treeGrid!==true&&a(l).jqGrid("setSelection",e[2]);a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose})}else c[l.p.id].clearAfterAdd&&
...
[b,u,a("#"+q),z]);c[l.p.id].afterComplete.call(l,b,u,a("#"+q),z);b=null},500)}if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate){a("#"+q).data("disabled",false);if(c[l.p.id]._savedData[l.p.id+"_id"]!=="_empty")for(m in c[l.p.id]._savedData)c[l.p.id]._savedData.hasOwnProperty(m)&&u[m]&&(c[l.p.id]._savedData[m]=u[m])}}c[l.p.id].processing=false;a("#sData",s+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+q)[0].focus()}catch(n){}}},a.jgrid.ajaxOptions,c[l.p.id].ajaxEditOptions);!n.url&&
...
!1,w=a.isFunction(c[l.p.id].afterShowForm)?c[l.p.id].afterShowForm:!1,x=a.isFunction(c[l.p.id].beforeInitData)?c[l.p.id].beforeInitData:!1,J=a.isFunction(c[l.p.id].onInitializeForm)?c[l.p.id].onInitializeForm:!1,y=!0,D=1,M=0,u,L,z,q=a.jgrid.jqID(q);"new"===e?(e="_empty",z="add",d.caption=c[l.p.id].addCaption):(d.caption=c[l.p.id].editCaption,z="edit");!0===d.recreateForm&&void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]&&a("#"+a.jgrid.jqID(t.themodal)).remove();var P=!0;d.checkOnUpdate&&d.jqModal&&!d.modal&&
(P=!1);if(void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]){y=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+a.jgrid.jqID(q)),z]);void 0===y&&(y=!0);y&&x&&(y=x.call(l,a("#"+q),z));if(!1===y)return;m();a(".ui-jqdialog-title","#"+a.jgrid.jqID(t.modalhead)).html(d.caption);a("#FormError",s).hide();c[l.p.id].topinfo?(a(".topinfo",s).html(c[l.p.id].topinfo),a(".tinfo",s).show()):a(".tinfo",s).hide();c[l.p.id].bottominfo?(a(".bottominfo",s+"_2").html(c[l.p.id].bottominfo),a(".binfo",s+"_2").show()):
a(".binfo",s+"_2").hide();h(e,l,q);"_empty"===e||!c[l.p.id].viewPagerButtons?a("#pData, #nData",s+"_2").hide():a("#pData, #nData",s+"_2").show();!0===c[l.p.id].processing&&(c[l.p.id].processing=!1,a("#sData",s+"_2").removeClass("ui-state-active"));!0===a("#"+q).data("disabled")&&(a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide(),a("#"+q).data("disabled",!1));a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+q),z]);v&&v.call(l,a("#"+q),z);a("#"+a.jgrid.jqID(t.themodal)).data("onClose",c[l.p.id].onClose);
a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,jqM:!1,overlay:d.overlay,modal:d.modal,overlayClass:d.overlayClass});P||a("."+a.jgrid.jqID(d.overlayClass)).click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+q),z]);w&&w.call(l,a("#"+q),z)}else{var V=isNaN(d.dataheight)?d.dataheight:
d.dataheight+"px",y=isNaN(d.datawidth)?d.datawidth:d.datawidth+"px",V=a("<form name='FormPost' id='"+q+"' class='FormGrid' onSubmit='return false;' style='width:"+y+";overflow:auto;position:relative;height:"+V+";'></form>").data("disabled",!1),Y=a("<table id='"+r+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),y=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+q),z]);void 0===y&&(y=!0);y&&x&&(y=x.call(l,a("#"+q,z)));if(!1===y)return;m();a(l.p.colModel).each(function(){var a=
this.formoptions;D=Math.max(D,a?a.colpos||0:0);M=Math.max(M,a?a.rowpos||0:0)});a(V).append(Y);x=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+2*D+"'></td></tr>");x[0].rp=0;a(Y).append(x);x=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*D+"'>"+c[l.p.id].topinfo+"</td></tr>");x[0].rp=0;a(Y).append(x);var y=(x="rtl"===l.p.direction?!0:!1)?"nData":"pData",W=x?"pData":"nData";b(e,l,Y,D);var y="<a href='javascript:void(0)' id='"+y+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
...
onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditInitializeForm",[a("#"+q),z]);J&&J.call(l,a("#"+q),z);"_empty"===e||!c[l.p.id].viewPagerButtons?a("#pData,#nData",s+"_2").hide():a("#pData,#nData",s+"_2").show();a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+q),z]);v&&v.call(l,a("#"+q),z);a("#"+a.jgrid.jqID(t.themodal)).data("onClose",c[l.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,overlay:d.overlay,
modal:d.modal,overlayClass:d.overlayClass});P||a("."+a.jgrid.jqID(d.overlayClass)).click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+q),z]);w&&w.call(l,a("#"+q),z);a(".fm-button","#"+a.jgrid.jqID(t.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",
s+"_2").click(function(){u={};a("#FormError",s).hide();f();if(u[l.p.id+"_id"]==="_empty")i();else if(d.checkOnSubmit===true)if(L=j(u,c[l.p.id]._savedData)){a("#"+q).data("disabled",true);a(".confirm","#"+a.jgrid.jqID(t.themodal)).show()}else i();else i();return false});a("#cData",s+"_2").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a("#nData",s+"_2").click(function(){if(!k())return false;
...
"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",q="",s=["integer","number","currency"],t=0,r=0,v,w,x;for(n=1;n<=f;n++)q+=1===n?p:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(c.p.colModel).each(function(){i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1;!i&&"right"===this.align&&(this.formatter&&-1!==a.inArray(this.formatter,s)?t=Math.max(t,
parseInt(this.width,10)):r=Math.max(r,parseInt(this.width,10)))});v=0!==t?t:0!==r?r:0;o=a(c).jqGrid("getInd",b);a(c.p.colModel).each(function(b){g=this.name;w=!1;l=(i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";x="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&x){k=!1===o?"":g===c.p.ExpandColumn&&!0===c.p.treeGrid?a("td:eq("+b+")",c.rows[o]).text():a("td:eq("+b+")",c.rows[o]).html();w="right"===this.align&&
0!==v?!0:!1;var d=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),n=parseInt(d.rowpos,10)||j+1,p=parseInt(2*(parseInt(d.colpos,10)||1),10);if(d.rowabove){var s=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+d.rowcontent+"</td></tr>");a(e).append(s);s[0].rp=n}h=a(e).find("tr[rowpos="+n+"]");0===h.length&&(h=a("<tr "+l+" rowpos='"+n+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(h).append(q),a(e).append(h),h[0].rp=n);a("td:eq("+(p-2)+")",h[0]).html("<b>"+(void 0===d.label?c.p.colNames[b]:
...
"#"+a.jgrid.jqID(p.modalhead)).html(d.caption);a("#FormError","#"+o).hide();h(e,j);a.isFunction(c[j.p.id].beforeShowForm)&&c[j.p.id].beforeShowForm.call(j,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(p.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d.jqModal,jqM:!1,overlay:d.overlay,modal:d.modal});f()}else{var v=isNaN(d.dataheight)?d.dataheight:d.dataheight+"px",w=isNaN(d.datawidth)?d.datawidth:d.datawidth+"px",n=a("<form name='FormPost' id='"+n+"' class='FormGrid' style='width:"+w+";overflow:auto;position:relative;height:"+
v+";'></form>"),x=a("<table id='"+l+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");q&&(r=q.call(j,a("#"+m)),void 0===r&&(r=!0));if(!1===r)return;a(j.p.colModel).each(function(){var a=this.formoptions;s=Math.max(s,a?a.colpos||0:0);t=Math.max(t,a?a.rowpos||0:0)});a(n).append(x);b(e,j,x,s);l="rtl"===j.p.direction?!0:!1;q="<a href='javascript:void(0)' id='"+(l?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
r="<a href='javascript:void(0)' id='"+(l?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";v="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+d.bClose+"</a>";if(0<t){var J=[];a.each(a(x)[0].rows,function(a,b){J[a]=b});J.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(J,function(b,d){a("tbody",x).append(d)})}d.gbox="#gbox_"+a.jgrid.jqID(k);n=a("<div></div>").append(n).append("<table border='0' class='EditTable' id='"+
o+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+d.labelswidth+"'>"+(l?r+q:q+r)+"</td><td class='EditButton'>"+v+"</td></tr></tbody></table>");a.jgrid.createModal(p,n,d,"#gview_"+a.jgrid.jqID(j.p.id),a("#gview_"+a.jgrid.jqID(j.p.id))[0]);l&&(a("#pData, #nData","#"+o+"_2").css("float","right"),a(".EditButton","#"+o+"_2").css("text-align","left"));d.viewPagerButtons||a("#pData, #nData","#"+o+"_2").hide();n=null;a("#"+p.themodal).keydown(function(b){if(b.which===27){c[j.p.id].closeOnEscape&&
...
e.length&&160===e.charCodeAt(0))e="";var v=a.jgrid.createEl.call(b,j[h].edittype,s,e,!0,a.extend({},a.jgrid.ajaxOptions,b.p.ajaxSelectOptions||{}));a(v).addClass("editable");k?a("span:first",this).append(v):a(this).append(v);a.jgrid.bindEv.call(b,v,s);"select"===j[h].edittype&&void 0!==j[h].editoptions&&!0===j[h].editoptions.multiple&&void 0===j[h].editoptions.dataUrl&&a.jgrid.msie&&a(v).width(a(v).width());f++}}),0<f&&(i.id=c,b.p.savedRow.push(i),a(h).attr("editable","1"),a("td:eq("+g+") input",
...
n[o]+" "+r[1],!1;m.p.autoencode&&(n[o]=a.jgrid.htmlEncode(n[o]));"clientArray"!==j.url&&t.editoptions&&!0===t.editoptions.NullIfEmpty&&""===n[o]&&(p[o]="null")}});if(!1===r[0]){try{var v=m.rows.namedItem(c),w=a.jgrid.findPos(v);a.jgrid.info_dialog(a.jgrid.errors.errcap,r[1],a.jgrid.edit.bClose,{left:w[0],top:w[1]+a(v).outerHeight()})}catch(x){alert(r[1])}return k}i=m.p.prmNames;v=c;w=!1===m.p.keyIndex?i.id:m.p.colModel[m.p.keyIndex+(!0===m.p.rownumbers?1:0)+(!0===m.p.multiselect?1:0)+(!0===m.p.subGrid?
1:0)].name;if(n){n[i.oper]=i.editoper;if(void 0===n[w]||""===n[w])n[w]=c;else if(s.id!==m.p.idPrefix+n[w]&&(i=a.jgrid.stripPref(m.p.idPrefix,c),void 0!==m.p._index[i]&&(m.p._index[n[w]]=m.p._index[i],delete m.p._index[i]),c=m.p.idPrefix+n[w],a(s).attr("id",c),m.p.selrow===v&&(m.p.selrow=c),a.isArray(m.p.selarrrow)&&(i=a.inArray(v,m.p.selarrrow),0<=i&&(m.p.selarrrow[i]=c)),m.p.multiselect))i="jqg_"+m.p.id+"_"+c,a("input.cbox",s).attr("id",i).attr("name",i);void 0===m.p.inlineData&&(m.p.inlineData=
{});n=a.extend({},n,m.p.inlineData,j.extraparam)}if("clientArray"===j.url){n=a.extend({},n,l);m.p.autoencode&&a.each(n,function(b,d){n[b]=a.jgrid.htmlDecode(d)});i=a(m).jqGrid("setRowData",c,n);a(s).attr("editable","0");for(w=0;w<m.p.savedRow.length;w++)if(""+m.p.savedRow[w].id===""+v){q=w;break}0<=q&&m.p.savedRow.splice(q,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[c,i,n,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,c,i,j);k=!0;a(s).removeClass("jqgrid-new-row").unbind("keydown")}else a("#lui_"+
...
r.displayValue,o[r.idx],r.value)}catch(s){m=r.displayValue}h+='<tr id="'+i+'" role="row" class= "ui-widget-content jqgroup ui-row-'+f.p.direction+" "+j+'"><td style="padding-left:'+12*r.idx+'px;" colspan="'+e+'">'+g+a.jgrid.template(b.groupText[r.idx],m,r.cnt,r.summary)+"</td></tr>";if(n-1===r.idx){var t=b.groups[q+1],v,w,x=void 0!==t?b.groups[q+1].startRow:c.length;for(w=r.startRow;w<x;w++)h+=c[w].join("");var J;if(void 0!==t){for(J=0;J<b.groupField.length&&t.dataIndex!==b.groupField[J];J++);l=b.groupField.length-
J}for(t=0;t<l;t++)if(p[t]){w="";b.groupCollapse&&!b.showSummaryOnHide&&(w=' style="display:none;"');h+="<tr"+w+' jqfootlevel="'+(r.idx-t)+'" role="row" class="ui-widget-content jqfoot ui-row-'+f.p.direction+'">';w=d(q,t,b.groups);var y=f.p.colModel,D,M=w.cnt;for(v=0;v<e;v++){var u="<td "+f.formatCol(v,1,"")+">&#160;</td>",L="{0}";a.each(w.summary,function(){if(this.nm===y[v].name){y[v].summaryTpl&&(L=y[v].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&this.v&&0<M&&(this.v/=
M);try{D=f.formatter("",this.v,v,this)}catch(b){D=this.v}u="<td "+f.formatCol(v,1,"")+">"+a.jgrid.format(L,D)+"</td>";return!1}});h+=u}h+="</tr>"}l=J}});a("#"+a.jgrid.jqID(f.p.id)+" tbody:first").append(h);h=null})},groupingGroupBy:function(c,e){return this.each(function(){"string"===typeof c&&(c=[c]);var d=this.p.groupingView;this.p.grouping=!0;void 0===d.visibiltyOnNextGrouping&&(d.visibiltyOnNextGrouping=[]);var f;for(f=0;f<d.groupField.length;f++)!d.groupColumnShow[f]&&d.visibiltyOnNextGrouping[f]&&
